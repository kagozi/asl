# ============================================================================
# experiments/train_modern.py
# ============================================================================
"""Training script for modern transformer model."""
...
from models.modern_transformer import create_modern_model
...
def main():
    parser = argparse.ArgumentParser(description='Train modern transformer model')
    parser.add_argument('--config', type=str, default='config/modern_config.yaml',
    ...
    for direction in directions:
        print("\n" + "="*80)
        print(f"Training Modern Transformer: {direction.upper()}")
        print("="*80 + "\n")
...
def train_single_direction(config, direction, device, resume_path=None):
    ...
    output_dir = Path('../santosh_lab/shared/KagoziA/sl/results') / f'modern_{direction}_{timestamp}'
    ...
    model = create_modern_model(config, len(src_vocab), len(tgt_vocab))
    ...
    # Save results to CSV
    results = {
        f'modern_{direction}': test_metrics
    }
